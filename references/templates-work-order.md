...
Use these for Manager-to-Developer work orders and Developer-to-Manager completion handoffs. These payloads assume direct `codex-thread` mode unless a section says otherwise.
